...
<ul role="menu" class="aui-nav">
  ...
  <li>
    ...
    <li id="user-options">
      <a href="/account/signin/?next=/lehre_prof_info_mngt_bfr/uebung1/src/0c46f9ad01282065f50b2df8725df2f272ac70d9/js/injectScript.js%3Fat%3Dmaster" class="aui-nav-link login-link">Log in</a>
    </li>
...
<header id="source-path">
    ...
    <div class="secondary-actions">
      <div class="aui-buttons">
          ...
          <a href="/lehre_prof_info_mngt_bfr/uebung1/src/0c46f9ad0128/js/injectScript.js?at=master"
            class="aui-button pjax-trigger" aria-pressed="true">
            Source
          </a>
          <a href="/lehre_prof_info_mngt_bfr/uebung1/diff/js/injectScript.js?diff2=0c46f9ad0128&at=master"
            class="aui-button pjax-trigger"
            title="Diff to previous change">
            Diff
          </a>
          <a href="/lehre_prof_info_mngt_bfr/uebung1/history-node/0c46f9ad0128/js/injectScript.js?at=master"
            class="aui-button pjax-trigger">
            History
          </a>
  ...
  <h1>
        ...
        <a href="/lehre_prof_info_mngt_bfr/uebung1/src/0c46f9ad0128?at=master"
          class="pjax-trigger root" title="lehre_prof_info_mngt_bfr/uebung1 at 0c46f9ad0128">uebung1</a> /
            ...
            <span class="file-name">injectScript.js</span>
  ...
  <div id="editor-container" class="maskable"
       ...
       data-branch="master"
       data-path="js/injectScript.js"
       data-source-url="/api/internal/repositories/lehre_prof_info_mngt_bfr/uebung1/src/0c46f9ad01282065f50b2df8725df2f272ac70d9/js/injectScript.js">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/lehre_prof_info_mngt_bfr/uebung1/full-commit/0c46f9ad0128/js/injectScript.js" id="full-commit-link"
        ...
        <div class="secondary">
          ...
          <div class="aui-buttons">
              ...
              <a href="/lehre_prof_info_mngt_bfr/uebung1/annotate/0c46f9ad01282065f50b2df8725df2f272ac70d9/js/injectScript.js?at=master"
                 class="aui-button aui-button-light pjax-trigger">Blame</a>
              
                
                <a data-embed-url="https://bitbucket.org/lehre_prof_info_mngt_bfr/uebung1/src/0c46f9ad01282065f50b2df8725df2f272ac70d9/js/injectScript.js?embed=t" class="aui-button aui-button-light js-embed-link">
                  Embed
                </a>
              
            
            <a href="/lehre_prof_info_mngt_bfr/uebung1/raw/0c46f9ad01282065f50b2df8725df2f272ac70d9/js/injectScript.js" class="aui-button aui-button-light">Raw</a>
          </div>
    ...
    <div class="file-source">
      <table class="codehilite highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre><a href="#injectScript.js-1"> 1</a>
<a href="#injectScript.js-2"> 2</a>
<a href="#injectScript.js-3"> 3</a>
<a href="#injectScript.js-4"> 4</a>
<a href="#injectScript.js-5"> 5</a>
<a href="#injectScript.js-6"> 6</a>
<a href="#injectScript.js-7"> 7</a>
<a href="#injectScript.js-8"> 8</a>
<a href="#injectScript.js-9"> 9</a>
<a href="#injectScript.js-10">10</a>
<a href="#injectScript.js-11">11</a>
<a href="#injectScript.js-12">12</a>
<a href="#injectScript.js-13">13</a>
<a href="#injectScript.js-14">14</a>
<a href="#injectScript.js-15">15</a>
<a href="#injectScript.js-16">16</a>
<a href="#injectScript.js-17">17</a>
<a href="#injectScript.js-18">18</a></pre></div></td><td class="code"><div class="codehilite highlight"><pre><span></span><a name="injectScript.js-1"></a><span class="cm">/*</span>
<a name="injectScript.js-2"></a><span class="cm"> * Dieses Script injeziert einen Div-Container mit der ID &quot;ratewindow&quot; in die aufgerufene Seite.</span>
<a name="injectScript.js-3"></a><span class="cm"> * Anschließend wird der Inhalt der Datei &quot;aufgabe4.php&quot; in das div geladen.</span>
<a name="injectScript.js-4"></a><span class="cm"> */</span>
<a name="injectScript.js-5"></a><span class="kd">function</span> <span class="nx">proceed</span><span class="p">()</span> <span class="p">{</span>
<a name="injectScript.js-6"></a>	<span class="k">if</span><span class="p">(</span><span class="o">!</span><span class="nx">$</span><span class="p">(</span><span class="s2">&quot;#ratewindow&quot;</span><span class="p">).</span><span class="nx">length</span><span class="p">){</span>
<a name="injectScript.js-7"></a>		<span class="nx">$</span><span class="p">(</span><span class="s2">&quot;body&quot;</span><span class="p">).</span><span class="nx">append</span><span class="p">(</span><span class="s2">&quot;&lt;div class=&#39;modal fade&#39; id=&#39;ratewindow&#39;&gt;&lt;/div&gt;&quot;</span><span class="p">);</span>
<a name="injectScript.js-8"></a>		<span class="nx">$</span><span class="p">(</span><span class="s2">&quot;#ratewindow&quot;</span><span class="p">).</span><span class="nx">load</span><span class="p">(</span><span class="s2">&quot;http://localhost/Uebung1/aufgabe4.php&quot;</span><span class="p">);</span>
<a name="injectScript.js-9"></a>		
<a name="injectScript.js-10"></a>		<span class="nx">$</span><span class="p">(</span><span class="s2">&quot;#ratewindow&quot;</span><span class="p">).</span><span class="nx">show</span><span class="p">();</span>
<a name="injectScript.js-11"></a>	<span class="p">}</span> <span class="k">else</span> <span class="p">{</span>
<a name="injectScript.js-12"></a><span class="c1">//		$(&quot;#ratewindow&quot;).modal(&quot;show&quot;);</span>
<a name="injectScript.js-13"></a>	<span class="p">}</span>
<a name="injectScript.js-14"></a><span class="p">};</span>
<a name="injectScript.js-15"></a>
<a name="injectScript.js-16"></a><span class="nx">jQuery</span><span class="p">(</span><span class="nb">document</span><span class="p">).</span><span class="nx">ready</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">$</span><span class="p">)</span> <span class="p">{</span>
<a name="injectScript.js-17"></a>	<span class="nx">proceed</span><span class="p">();</span>
<a name="injectScript.js-18"></a><span class="p">});</span>
</pre></div>
</td></tr></table>
    </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger filter-item-link" href="/lehre_prof_info_mngt_bfr/uebung1/src/[[changeset]]/js/injectScript.js?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger filter-item-link" href="/lehre_prof_info_mngt_bfr/uebung1/src/[[changeset]]/js/injectScript.js?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","queueTime":0,"licenseKey":"a2cef8c3d3","agent":"","transactionName":"Z11RZxdWW0cEVkYLDV4XdUYLVEFdClsdAAtEWkZQDlJBGgRFQhFMQl1DXFcZQ10AQkFYBFlUVlEXWEJHAA==","applicationID":"1841284","errorBeacon":"bam.nr-data.net","applicationTime":118}</script>
</body>
</html>